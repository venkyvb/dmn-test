...
public final class App {
        ...
        private static String setUpRuleSet2(String ruleSetId) {
                ...
                decisionTableInputs.add(new DecisionTableInput("urn_validity", "urn_validity", "date", "Validity"));
                ...
                inputValues1.add("[date and time(\"2020-10-01T00:00:00\")..date and time(\"2020-12-31T00:00:00\")]");
                rules.add(new RuleEntry(inputValues1, "50"));

                List<String> inputValues2 = new LinkedList<>();
                inputValues2.add("\"LNPRF\"");
                inputValues2.add("[date and time(\"2020-01-01T00:00:00\")..date and time(\"2020-09-30T00:00:00\")]");
                rules.add(new RuleEntry(inputValues2, "25"));

                DecisionTableMetadata metadata = new DecisionTableMetadata(ruleSetId, decisionTableInputs,
                                decisionTableOutputs, HitPolicy.UNIQUE);
        ...
        private static void testRuleSet1() {
                ...
                System.out.println(DmnModelHandler.evaluateRules(ruleSetId, dmnModel, Variables.createVariables()
                                .putValue("urn_type", "LNPRF").putValue("urn_family", "LITS").putValue("urn_term", 12))
                                .toString());

                System.out.println(DmnModelHandler.evaluateRules(ruleSetId, dmnModel, Variables.createVariables()
                                .putValue("urn_type", "LNPRF").putValue("urn_family", "LILS").putValue("urn_term", 12))
                                .toString());

                System.out.println(DmnModelHandler.evaluateRules(ruleSetId, dmnModel, Variables.createVariables()
                                .putValue("urn_type", "LNPRF").putValue("urn_family", "LISS").putValue("urn_term", 12))
                                .toString());

                System.out.println(DmnModelHandler.evaluateRules(ruleSetId, dmnModel, Variables.createVariables()
                                .putValue("urn_type", "LISS").putValue("urn_family", "LISS").putValue("urn_term", 12))
                                .toString());
                ...
                System.out.println(DmnModelHandler.evaluateRules(ruleSetId, dmnModel, Variables.createVariables()
                                .putValue("urn_type", "LISS").putValue("urn_family", "LISS").putValue("urn_term", 26))
                                .toString());

                System.out.println(DmnModelHandler.evaluateRules(ruleSetId, dmnModel, Variables.createVariables()
                                .putValue("urn_type", "LISS").putValue("urn_family", "LISS").putValue("urn_term", 36))
                                .toString());

                System.out.println(DmnModelHandler.evaluateRules(ruleSetId, dmnModel, Variables.createVariables()
                                .putValue("urn_type", "ABC").putValue("urn_family", "LISS").putValue("urn_term", 36))
                                .toString());
        }
}
